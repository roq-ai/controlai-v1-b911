...
import { useModelFindFirst, useRoqClient } from 'lib/roq';

import { ModelInterface } from 'interfaces/model';
import { AttackListPage } from 'pages/attacks';
import { DefenseListPage } from 'pages/defenses';
...
function ModelViewPage() {
  ...
  const { data, error, isLoading } = useModelFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('model', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/models/edit/${id}`} passHref legacyBehavior>
                    <Button
