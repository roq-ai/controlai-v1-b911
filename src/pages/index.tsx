...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ControlAI v1`}</title>

        <meta
          name="description"
          content="Welcome to ControlAI v1 - Your trusted partner in verifying and enhancing machine learning models' robustness. Upload, execute attacks, analyze results, and get recommended defenses, all in one user-friendly dashboard."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594643781026-abcb610d394f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYWNoaW5lJTJCbGVhcm5pbmd8ZW58MHx8fHwxNjk4MzQzNDk3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ControlAI v1 - Your trusted partner in verifying and enhancing machine learning models' robustness. Upload, execute attacks, analyze results, and get recommended defenses, all in one user-friendly dashboard.`}
            </Text>
            <Box
