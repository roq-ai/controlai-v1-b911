...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'security-analyst', 'data-scientist', 'team-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Attacks', path: '/attacks', entity: 'attack', service: AccessServiceEnum.PROJECT, icon: FiAlertTriangle },
    { name: 'Defenses', path: '/defenses', entity: 'defense', service: AccessServiceEnum.PROJECT, icon: FiShieldOff },
    { name: 'Models', path: '/models', entity: 'model', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
